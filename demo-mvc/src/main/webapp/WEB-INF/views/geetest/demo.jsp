...
<h1>极验验证SDKDemo</h1>
<hr>
<form action="/geetest/validate1" method="post">
...
<script type="text/javascript" src="<c:url value='/js/geetest.js'/>"></script>
...
<script>
    ...
    $.ajax({
        url: "make1?t=" + (new Date()).getTime(), // 加随机数防止缓存
        type: "get",
        dataType: "json",
...
<script>
    ...
    $.ajax({
        url: "make2?t=" + (new Date()).getTime(), // 加随机数防止缓存
        type: "get",
        dataType: "json",
        success: function (data) {
            // 调用 initGeetest 初始化参数
