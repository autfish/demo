...
/**
 * This Example will demonstrate how job parameters can be passed into jobs and
 * how state can be maintained
 * 
 * @author Bill Kratzer
 */
public class JobStateExample {
	...
	public void run() throws Exception {
		...
		// job1 will only run 5 times (at start time, plus 4 repeats), every 10
		// seconds
		...
		log.info(job1.getKey()
				...
				+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS")
						.format(scheduleTime1) + " and repeat: "
				+ trigger1.getRepeatCount() + " times, every "
		...
		log.info(job2.getKey().toString()
				+ " will run at: "
				+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS")
						.format(scheduleTime2) + " and repeat: "
				+ trigger2.getRepeatCount() + " times, every "
