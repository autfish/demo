...
public class SimpleTriggerExample {
	...
	public void run() throws Exception {
		...
		log.info(job.getKey() + " will run at: "
				+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(ft)
		...
		log.info(job.getKey() + " will [also] run at: "
				+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(ft)
				+ " and repeat: " + trigger.getRepeatCount() + " times, every "
				+ trigger.getRepeatInterval() / 1000 + " seconds");
		...
		log.info("job7 rescheduled to run at: "
				+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(ft));
