...
public class DumbInterruptableJob implements InterruptableJob {
	...
	public void execute(JobExecutionContext context)
		...
		try {
			// main job loop... see the JavaDOC for InterruptableJob for
			// discussion...
			// do some work... in this example we are 'simulating' work by
			// sleeping... :)
			...
			for (int i = 0; i < 4; i++) {
				...
				if (_interrupted) {
					...
					return; // could also choose to throw a
	...
	/**
	 * <p>
	 * Called by the <code>{@link Scheduler}</code> when a user interrupts the
	 * <code>Job</code>.
	 * </p>
	 * 
