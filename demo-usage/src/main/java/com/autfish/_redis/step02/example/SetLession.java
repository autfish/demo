package com.autfish._redis.step02.example;
...
import com.autfish._redis.step01.basic.JedisProvider;
...
public class SetLession {
	...
	public static void main(String[] args) {
		...
		//按分类查找
		List<Goods> listBySize = sl.findGoodsBySize("big");
		System.out.println("所有尺寸为big的商品:");
		for(Goods goods : listBySize) {
			System.out.println(goods);
		}
		List<Goods> listBySizeAndColor = sl.findGoodsBySizeAndColor("big", "green");
		System.out.println("所有尺寸为big,颜色为green的商品:");
		for(Goods goods : listBySizeAndColor) {
			System.out.println(goods);
		}
	}
	...
	private final String[] COST = { "cheap", "expensive" };
	...
	public boolean addGoods(Goods goods) {
		...
		String cost = COST[new Random().nextInt(COST.length)];
	 ...
	 * @return
	 */
	public List<Goods> findGoodsBySizeAndColor(String size, String color) {
